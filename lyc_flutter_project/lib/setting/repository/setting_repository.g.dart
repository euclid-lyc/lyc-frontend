...
class _SettingRepository implements SettingRepository {
  ...
  @override
  Future<ApiResponse<PushAlarmModel>> getPushAlarms() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<PushAlarmModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<PushAlarmModel> _value;
    try {
      _value = ApiResponse<PushAlarmModel>.fromJson(
        _result.data!,
        (json) => PushAlarmModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<ApiResponse<PushAlarmModel>> updatePushAlarms(
      {required PushAlarmModel pushAlarmModel}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(pushAlarmModel.toJson());
    final _options = _setStreamType<ApiResponse<PushAlarmModel>>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
