...
class _MypageRepository implements MypageRepository {
  ...
  @override
  Future<ApiResponse<Profile>> getProfile({required memberId}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<ApiResponse<SavedResult>> unsavePosting({required postingId}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<ApiResponse<DelPosting>> deleteCoordi({required postingId}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<ApiResponse<FollowListResult>> getFollowerList({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<FollowListResult>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ApiResponse<FollowListResult>.fromJson(
      _result.data!,
  ...
  Future<ApiResponse<FollowActingResult>> followUser(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<FollowActingResult>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ApiResponse<FollowActingResult>.fromJson(
      _result.data!,
  ...
  Future<ApiResponse<PossibleReviewList>> getPossibleReviewList({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<PossibleReviewList>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ApiResponse<PossibleReviewList>.fromJson(
      _result.data!,
      (json) => PossibleReviewList.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }
