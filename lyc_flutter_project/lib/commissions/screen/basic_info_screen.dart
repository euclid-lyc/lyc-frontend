...
class BasicInfoScreen extends StatefulWidget {
  const BasicInfoScreen({super.key, required this.directorId, this.model});
...
class BasicInfoScreenState extends State<BasicInfoScreen> {
  ...
  void initState() {
    ...
    if (model != null) {
      _controller1_1.controller.text = model.commissionInfo.height as String;
      _controller1_2.controller.text = model.commissionInfo.weight as String;
      _controller1_3.controller.text = model.commissionInfo.topSize;
      _controller1_4.controller.text = model.commissionInfo.bottomSize;
    }
  }
          ...
          basicInfo: BasicInfo(
              ...
              infoStyle: InfoStyle(
                  ...
                  nonPreferredStyleList:
                      _controller3.controller.text.split(',')),
              infoFit: InfoFit(
              ...
              infoMaterial: InfoMaterial(
                  preferredMaterialList:
                      _controller4.controller.text.split(','),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(bottom: 20),
                      child:
                          buildAdditionalInfo('Step 10.추가로 작성하고 싶은 내용이 있나요?'),
