...
class CommissionsProvider with ChangeNotifier {
  late final CommissionsRepositoryProvider provider;
  ...
  //   }
  // }
  Future<void> terminateCommission(
      {required int chatId}) async {
    final resp = await provider.commissionsRepository.terminateCommission(chatId: chatId);
