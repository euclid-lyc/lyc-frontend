...
import 'find_pw_screen_1.dart';
import 'find_pw_screen_3.dart';

class FindPwScreen2 extends StatelessWidget {
  FindPwScreen2({super.key});

  final Controller _codeController = Controller();

  @override
  Widget build(BuildContext context) {
    final findPwProvider = Provider.of<FindPwProvider>(context, listen: false);
            ...
            children: [
              ...
              Container(
                  ...
                  child: TwoButtons(
                    ...
                    scdOnPressed: () async {
                      try {
                        await findPwProvider.checkVerificationCode(
