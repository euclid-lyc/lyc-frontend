...
import 'package:lyc_flutter_project/auth/join/model/member.dart';
...
class JoinScreenState1 extends State<JoinScreen1> {
  ...
  final Controller _phoneController = Controller();
  ...
  void _tryValidation() {
    ...
    if (isValid) {
      ...
      joinProvider.member = Member(
          ...
          loginId: _idController.controller.text,
          loginPw: _pwController.controller.text,
            ...
            child: Padding(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  ...
                  } else if (value != _pwController.controller.text) {
  ...
  InputDecoration getDecoration(String hintText, TextStyle style) {
