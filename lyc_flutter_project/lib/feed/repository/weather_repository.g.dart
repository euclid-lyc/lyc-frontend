...
class _WeatherRepository implements WeatherRepository {
  ...
  @override
  Future<ApiResponse<WeatherResult>> getWeather({required weatherQuery}) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<WeatherResult>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ApiResponse<WeatherResult>.fromJson(
      _result.data!,
