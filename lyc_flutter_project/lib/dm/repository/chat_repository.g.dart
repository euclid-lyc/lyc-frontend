...
class _ChatRepository implements ChatRepository {
  ...
  Future<ApiResponse<ChatListModel>> getChatList({
    ...
    final _options = _setStreamType<ApiResponse<ChatListModel>>(
  ...
  Future<ApiResponse<ChatRoomModel>> getChatMessages({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<ChatRoomModel>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<ChatRoomModel> _value;
    try {
      _value = ApiResponse<ChatRoomModel>.fromJson(
        _result.data!,
  ...
  Future<ApiResponse<MakeScheduleModel>> makeSchedule({
    ...
    final _options = _setStreamType<ApiResponse<MakeScheduleModel>>(
  ...
  Future<ApiResponse<ScheduleModelListResponse>> getSchedules({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<ScheduleModelListResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${chatId}/schedules',
  ...
  Future<ApiResponse<ChatImageListModel>> getImages({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<ChatImageListModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${chatId}/images',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<ChatImageListModel> _value;
    try {
      _value = ApiResponse<ChatImageListModel>.fromJson(
        _result.data!,
        (json) => ChatImageListModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<ApiResponse<ChatImageModel>> getAImage({
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<ChatImageModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${chatId}/images/${imageId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<ChatImageModel> _value;
    try {
      _value = ApiResponse<ChatImageModel>.fromJson(
        _result.data!,
        (json) => ChatImageModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<ApiResponse<String>> terminateChat({required int chatId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': 'true'};
    _headers.removeWhere((k, v) => v == null);
